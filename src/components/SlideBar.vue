<template>
  <div class="slide-bar">
    <h1 style="color: red">Tsd</h1>
    <div class="slide-bar--inner">
      <div class="sidebar__header">
        <a class="slidebar-sidebar__logo" href="#">
          <!-- logo -->
          <div class="slidebar-sidebar-logo">
            ...
            <div class="slidebar-sidebar-logo__caption">Admin</div>
          </div>
          <!-- logo / end -->
        </a>
      </div>
      <ul class="slidebar__menu">
        <!-- dashboard -->
        <li class="slidebar__menu-item">
          <a href="#" class="slidebar-nav__link"
            ><span class="slidebar-nav__icon"
              ><svg
                width="1em"
                height="1em"
                viewBox="0 0 16 16"
              ...
              >
                ...
                ></path></svg></span
            ><span class="slidebar-nav__title">Dashboard</span></a
          >
        </li>
        <!-- catalog -->
        <li
          class="slidebar__menu-item"
          @click="(e) => e.target.classList.toggle('active')"
        >
          <a
            class="slidebar-nav__link"
            ...
            ><span class="slidebar-nav__icon"
              ...
              >
                ...
                ></path></svg></span
            ><span class="slidebar-nav__title">Catalog</span
            ><span class="slidebar-nav__arrow"
              ><svg
                xmlns="http://www.w3.org/2000/svg"
                width="6"
                height="9"
          ...
          ></a>
          <ul
            class="slidebar-nav__menu slidebar-nav__menu--sub collapse"
            id="catalog"
          >
            <li class="slidebar-nav__menu-item">
              <a href="" class="slidebar-nav__link"
                ><span class="slidebar-nav__menu-item-padding"></span
                ><span class="slidebar-nav__title">Products List</span></a
              >
            </li>
            <li class="slidebar-nav__menu-item">
              <a href="app-product.html" class="slidebar-nav__link"
                ><span class="slidebar-nav__menu-item-padding"></span
                ><span class="slidebar-nav__title">Product</span></a
              >
            </li>
            <li class="slidebar-nav__menu-item">
              <a href="app-categories-list.html" class="slidebar-nav__link"
                ><span class="slidebar-nav__menu-item-padding"></span
                ><span class="slidebar-nav__title">Categories List</span></a
              >
            </li>
            <li class="slidebar-nav__menu-item">
              <a href="app-category.html" class="slidebar-nav__link"
                ><span class="slidebar-nav__menu-item-padding"></span
                ><span class="slidebar-nav__title">Category</span></a
              >
            </li>
          </ul>
        </li>
        ...
        <li class="slidebar__menu-item">
          <a
            ...
            ><span class="slidebar-nav__icon"
              ...
              >
                ...
                ></path></svg></span
            ><span class="slidebar-nav__title">Customer</span
            ><span class="slidebar-nav__arrow"
              ><svg
                xmlns="http://www.w3.org/2000/svg"
                width="6"
          ...
          >
            <li class="slidebar-nav__menu-item">
              <a href="" class="slidebar-nav__link"
                ><span class="slidebar-nav__menu-item-padding"></span
                ><span class="slidebar-nav__title">Customers List</span></a
              >
            </li>
            <li class="slidebar-nav__menu-item">
              <a href="" class="slidebar-nav__link"
                ><span class="slidebar-nav__menu-item-padding"></span
                ><span class="slidebar-nav__title">Customer</span></a
              >
            </li>
          </ul>
        </li>
        ...
        <li class="slidebar__menu-item">
          <a
            ...
            ><span class="slidebar-nav__icon"
              ...
              >
                ...
                ></path></svg></span
            ><span class="slidebar-nav__title">Orders</span
            ><span class="slidebar-nav__arrow"
              ><svg
                xmlns="http://www.w3.org/2000/svg"
                width="6"
          ...
          >
            <li class="slidebar-nav__menu-item">
              <a href="" class="slidebar-nav__link"
                ><span class="slidebar-nav__menu-item-padding"></span
                ><span class="slidebar-nav__title">Orders List</span></a
              >
            </li>
            <li class="slidebar-nav__menu-item">
              <a href="" class="slidebar-nav__link"
                ><span class="slidebar-nav__menu-item-padding"></span
                ><span class="slidebar-nav__title">Order Details</span></a
              >
            </li>
          </ul>
        </li>
          ...
          <a href="#" class="slidebar-nav__link"
            ><span class="slidebar-nav__icon"
              ...
              >
                ...
                ></path></svg></span
            ><span class="slidebar-nav__title">Analytics</span></a
          >
        </li>
      </ul>
    </div>
...
.slide-bar {
  ...
  .sidebar__header {
    ...
    .slidebar-sidebar-logo {
      ...
      .slidebar-sidebar-logo__caption {
